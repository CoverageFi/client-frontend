...
import { BlockchainEnum, TokenBalance, Wallet, WalletBalancesInput, WalletsInput } from "../shared/types";

const walletBalanceHelper = async (id: string, params?: WalletBalancesInput) => {
  return axios.get<{
