...
export default function WalletPage() {
  ...
  const refetchIntervalFn: UseQueryOptions["refetchInterval"] = (_data, query) => {
  ...
  return (
    <div className="flex flex-col pt-16 text-center items-center h-1/2 px-6">
      <LoadingWrapper isLoading={loading}>
        <Image src={"/ErrorIcon.svg"} height={100} width={100} alt="No wallets" className="mb-6" />

        <Typography level="title-lg" className="text-neutral-400 mb-1.5">
          Something went wrong
        </Typography>
        <Typography level="body-md" fontWeight={500} className="text-neutral-400 mb-6">
