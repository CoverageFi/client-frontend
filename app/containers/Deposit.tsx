  ...
  return (
    <Content>
      ...
      <div className="flex flex-col items-center justify-center mx-auto self-stretch gap-8 w-full">
        <Typography>Use the QR code or wallet address to deposit directly to this wallet.</Typography>
        <QRCode value={walletAddress} />
        <CopyButton variant="solid" copyValue={walletAddress} copyLabel={walletAddress} />
      </div>
    </Content>
  );
};
