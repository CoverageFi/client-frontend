import { BackButton, Content, CopyButton, useSendTokenContext, useW3sContext } from "@/app/components";
import Image from "next/image";
import { calculateEstimatedFee, roundNum, tokenHelper } from "@/app/shared/utils";
...
export const SendTokenConfirm = () => {
  const { tokenName, walletId, setStep, tokenAndRecipient, estimatedFee } = useSendTokenContext();
    ...
    <>
      <Content>
        ...
        <div className="flex flex-col items-center mb-4">
          <Image className="mb-4" src={imageSymbol.svg} width={80} height={80} alt="coin alt" />
        ...
        <div className="grow flex flex-col gap-y-2">
          <TextField
            ...
            readOnly
          />
          <TextField value={blockchainNames[tokenAndRecipient.network as BlockchainEnum]} label="Network" readOnly />
          <TextField
            readOnly
            startDecorator={
